export function addToolbar(parentTag) {
  ...
  const toolbarButtonSearchIcon = document.createElement("svg");
  const toolbarButtonSearchIconPath = document.createElement("path");
  ...
  const toolbarButtonThemeIcon = document.createElement("svg");
  const toolbarButtonThemeIconPath = document.createElement("path");
  ...
  toolbarButtonSearchIcon.width = "21";
  toolbarButtonSearchIcon.height = "22";
  toolbarButtonSearchIcon.viewBox = "0 0 21 22";
  toolbarButtonSearchIcon.fill = "none";

  toolbarButtonSearchIconPath.d =
  ...
  toolbarButtonSearchIconPath.fill = "#6C63FF";

  toolbarSelectList.name = "task-type";
  toolbarSelectList.id = "task-type";

  toolbarButtonThemeIcon.width = "22";
  toolbarButtonThemeIcon.height = "22";
  toolbarButtonThemeIcon.viewBox = "0 0 22 22";
  toolbarButtonThemeIcon.fill = "none";

  toolbarButtonThemeIconPath.fillRule = "evenodd";
  toolbarButtonThemeIconPath.clipRule = "evenodd";
  toolbarButtonThemeIconPath.d =
  ...
  toolbarButtonThemeIconPath.fill = "#F7F7F7";
